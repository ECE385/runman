...
HD_PWD='C:/Users/ramseyv2/repos/runman/runman.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log runman_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source runman_top.tcl -notrace
